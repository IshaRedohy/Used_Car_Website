...
# # List of image paths
# image_paths = ['/Users/shahisharedohy/Desktop/my_aws/dummy/storage/media/hridoy1.jpeg', '/Users/shahisharedohy/Desktop/my_aws/dummy/storage/media/hridoy2.jpeg', '/Users/shahisharedohy/Desktop/my_aws/dummy/storage/media/hridoy3.jpeg']
...
# # Create table if not exists
# create_table_query = '''
# CREATE TABLE IF NOT EXISTS dummy_images (
#     id INT AUTO_INCREMENT PRIMARY KEY,
#     image_path VARCHAR(255),
#     image_data LONGBLOB
# );
...
#     # Insert image path and data into the database
#     insert_query = '''
#     INSERT INTO dummy_images (image_path, image_data)
#     VALUES (%s, %s);
#     '''
#     with open(image_path, 'rb') as image_file:
#         image_data = image_file.read()
